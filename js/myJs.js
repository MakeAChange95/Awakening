...
function generateData(){
	...
	for (var i = 0; i < crimes.length; i++) {
      document.getElementById('body').innerHTML +=
            ...
            '<td class="center">' + crimes[i].id + "</td>" +
            '<td class="center">' + crimes[i].numberPlate + "</td>" +
            '<td class="center">' + crimes[i].typeOfTransport + "</td>" +
            '<td class="center">' + crimes[i].typeOfCrime + "</td>" +
            '<td class="center">' + crimes[i].date + "</td>" +
            '<td class="center">' + crimes[i].location + "</td>" +
